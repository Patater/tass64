...
static const struct w16_s zw32[] = {
...
static const struct w16_s dw32[] = {
...
int wcwidth_v13(unichar_t ch) {
    ...
    if (ch < 0x20000) {
        ch &= 0xffff;
        if (bsearch(&ch, zw32, lenof(zw32), sizeof *zw32, compw16) != NULL) return 0;
        if (bsearch(&ch, dw32, lenof(dw32), sizeof *dw32, compw16) != NULL) return 2;
        return 1;
    }
